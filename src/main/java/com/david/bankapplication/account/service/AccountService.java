...
public interface AccountService {
    ...
    //계좌 이체
    TransactionLogDto transferAccount(Long userId, String fromAccountBankCode, String fromAccountBankNumber, String toAccountBankCode, String toAccountBankNumber, String comment, Long transferAmount) throws NoAccountException, AuthorizationException, TemporarilyUnavailableException, BankAPIException;
